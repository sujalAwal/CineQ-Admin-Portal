...
@Component({
  selector: 'app-crew-roles-modal',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, BaseModalComponent],
  templateUrl: './crew-roles-modal.component.html',
  styleUrls: ['./crew-roles-modal.component.scss']
})
export class CrewRolesModalComponent implements OnInit, OnChanges {
  ...
  constructor(
    ...
    private service: CrewRolesService,
  ...
  private initializeForm(): void {
    this.form = this.fb.group({
      ...
      slug: ['', [Validators.required, Validators.minLength(2), Validators.maxLength(50)]],
  ...
  private updateModalConfig(): void {
    if (this.item) {
      this.modalConfig.title = 'Edit Crew Role';
      this.modalConfig.primaryButtonText = 'Update Role';
    } else {
      this.modalConfig.title = 'Add Crew Role';
