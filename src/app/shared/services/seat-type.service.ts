...
export class SeatTypeService {
  ...
  private readonly SLUG = 'seat-types';
  ...
  bulkDelete(ids: string[]): Observable<boolean> {
    return this.http.delete<any>(`${this.baseUrl}/delete`, { body: { ids, formSlug: this.SLUG, collectionName: 'seat_types' }, withCredentials: true })
      .pipe(map(r => r.success ? true : (() => { throw new Error(r?.message || 'Failed'); })()),
        catchError(e => this.handleError(e)));
  }
