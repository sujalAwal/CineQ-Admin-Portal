      ...
      this.artistsData = [
        {
          ...
          artist_type_name: 'Actor',
          movies_count: 28,
          rating: 4.9,
          is_active: true,
          created_at: '2019-03-15',
          can_edit: true,
          can_delete: false, // Cannot delete famous actor
          can_view: true
        },
        {
          id: 2,
          full_name: 'Christopher Nolan',
          email: 'chris.nolan@example.com',
          avatar: 'https://via.placeholder.com/40x40?text=CN',
          artist_type_name: 'Director',
          movies_count: 12,
          rating: 4.8,
          is_active: true,
        ...
        },
        {
          ...
          artist_type_name: 'Composer',
          movies_count: 156,
          rating: 5.0,
          is_active: false, // Inactive composer
          is_active_disabled: true, // Admin cannot change this
          created_at: '2015-11-03',
          can_edit: false, // Cannot edit legendary composer
          can_delete: false,
          can_view: true
        },
        {
        ...
        },
        {
          ...
          avatar: 'https://via.placeholder.com/40x40?text=QT',
          artist_type_name: 'Director',
          movies_count: 10,
          rating: 4.9,
          is_active: true,
