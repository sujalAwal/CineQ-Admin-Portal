...
@Component({
  ...
  providers: [
    { provide: SETTING_FORM_SLUG, useValue: 'customer-portal-settings' },
    SettingService
  ],
...
export class CustomerPortalSettingsComponent implements OnInit, OnDestroy {

  readonly MODULE_TITLE = 'Customer Portal Setting';
  readonly MODULE_TITLE_PLURAL = 'Customer Portal Settings';
